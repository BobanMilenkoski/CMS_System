    ...
    <div class="col-lg-3 col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                               ...
                               <?php   
                                ...
                                $categoris_counts = mysqli_num_rows($select_all_categories);

                                echo  "<div class='huge'>{$categoris_counts}</div>" 
      ...
      function drawChart() {
        ...
        <?php
            ...
            $element_count = [$post_counts,$post_published_counts, $post_draft_counts, $comments_counts, $unapproved_comment_count, $users_counts, $subscriber_count, $categoris_counts ];
